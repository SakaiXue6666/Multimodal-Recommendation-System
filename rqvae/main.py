...
from models.rqvae import *
from rqvae.models.rqvae import RQVAE
...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, default="../data/Beauty/item_mul_emb.parquet", help="Input data path.")
